<p align="center">
    ...
    <h2 align="center">Rosé Pine for iSH</h2>
</p>
...
### 2. Clone repository and copy theme files

```sh
git clone https://github.com/akopdev/rose-pine-ish.git rose-pine-ish
cp -r rose-pine-ish/*.json /mnt/themes
```

You can also download the JSON files manually to the iSH theme directory, without cloning whole repository.
